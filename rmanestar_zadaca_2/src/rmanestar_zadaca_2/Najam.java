...
public class Najam {
    ...
    public static Najam dohavatiNajamSPocetnimDatumom(int osobaId, int vrstaVozilaId, int lokacijaId){
        ArrayList<Najam> lista = PostavkeSingleton.getNajamLista();
        for(Najam n : lista ){
            if(n.getOsosbaId()==osobaId && n.getVoziloVrstaId()==vrstaVozilaId && n.getLokacijaId()==lokacijaId && n.getKrajNajma()==null){
                return n;
            }
        }
        return null;
